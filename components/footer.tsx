...
const Footer = () => {
  return (
    <footer className="font-dosis bg-purple-mountains-majesty-600 border-t border-szary">
      <Container>
        <div className="pt-14 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex lg:flex-row justify-start items-center lg:pl-4 lg:w-1/2">
            <a
              ...
              className="text-white duration-200 transition-colors p-4 mx-4 border rounded-full"
            >
              <svg
