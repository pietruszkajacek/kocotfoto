...
export default function Menu({ itemsMenu }: Props) {
    ...
    return (
        <Disclosure as="nav" className={classNames(navbarShrinked ? menuStyles['navbar-shrink'] : 'bg-[#e3e3e3] sm:bg-[#e3e3e34f]', 'transition duration-100 fixed top-0 left-0 right-0')}>
            {({ open }) => (
                <Container>
                        ...
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-start">
                                <div className="flex flex-shrink-0 items-center text-[#8670B3]">
                                    <a
                                        href='/'
                                        className={'text-[#8670B3] px-3 py-2 text-sm font-medium'}
                                    >
                                        ...
                                        {itemsMenu.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'bg-gray-900 text-white' : 'text-[#8670B3] hover:bg-gray-700 hover:text-white',
